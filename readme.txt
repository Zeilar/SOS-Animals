...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/sosa.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/sosa)
...
Website: [https://sosa.com](https://sosa.com)

Child Theme Project: [https://github.com/holger1411/sosa-child](https://github.com/holger1411/sosa-child)
...
- Jetpack ready.
- WooCommerce support.
- [Child Theme](https://github.com/holger1411/sosa-child) ready.
- Translation ready.
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 3 "sosa/sosa"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the sosa folder from GitHub or from sosa.com
- IMPORTANT: If you download it from GitHub make sure you rename the "sosa-master.zip" file just to "sosa.zip" or you might have problems using child themes !!
