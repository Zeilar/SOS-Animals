	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'myportfolio' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'myportfolio' ); ?></th>
			</tr>
		</thead>
		<tbody>
