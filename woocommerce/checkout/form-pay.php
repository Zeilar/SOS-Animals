	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'sosa' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'sosa' ); ?></th>
			</tr>
		</thead>
		<tbody>
